 ...
 // if(isLoading)
  ...
  <div>
      ...
      <div className="col-10 offset-2">
       <p>Llenar informacion del cliente</p><br />
        ...
        <div className="row">
         <div className="col-9 offset-3"> <h3>Composicion Corporal</h3></div>
          ...
          <input type="tex"  name="TBWBodyFat" placeholder="Body Fat" value ={TBWBodyFat} onChange={this.onTextBoxChange}/><br />
            ...
            <div className="col-9 offset-3"> <h3>Evaluacion de control de peso</h3></div> 
            <div className="col-10 offset-2">
            <input type="tex"   name =" weight" placeholder="Weight" value ={weight} onChange={this.onTextBoxChange}/><br />
            ...
            <div className ="col-9 offset-3"> <h3>Gasto de energia</h3> </div>
            <div className="col-10 offset-2">
            ...
            <select name ="BodyType"  onChange={this.onTextBoxChange}>
                <option  value="Thin with excess fat" >Delgado con poco pesos de mas</option>
                <option  value="OverWeight" >Sobrepeso</option>
                <option  value="Obesity" >Obesidad</option>
                <option  value="UnderWeight" >Bajo de peso</option>
                <option  value="Normal" >Normal</option>
                <option  value="Muscular OverWeight" >Sobrepeso muscular</option>
                <option  value="Low Fat Mass And Low Weight" >Bajo nivel de grasa y de peso</option>
                <option  value="Low Fat Mass And Muscular Mass" >Bajo nivel de peso y musculo</option>
                <option  value="Atlethic" >Atletico</option>
          </select>
            </div>  
            </div>

        <button onClick={this.onUpdateCorpA}>Guardar</button>
