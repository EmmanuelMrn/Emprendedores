        ...
        <div class="row">
            ...
            <div class="col-4">
        		...
        		<div class="col-md-6">
	        		...
	        		<p class="text-center"><em>Nombre de usuario: {user.Email}</em></p>
        		</div>

        		<div class="col-md-8">
        			<br />
        			<ul class="list-group list-primary">
                        <a class="list-group-item">Nombre: {user.FirstName}</a>
        				<a class="list-group-item">Apellido: {user.LastName}</a>
        				<a class="list-group-item">Telefono: {user.Phone}</a>
        				<a class="list-group-item">Correo: {user.Email}</a>
        				<a class="list-group-item">Rol: {user.Role}</a>
    				</ul>
    			</div>   
            </div>
