...
class Header extends Component {
  ...
  render() {
    ...
    if (!localStorage.hasOwnProperty('AssignedNutriologist')) {
      Catalogue = (
        <li>
          <Link to="/catalogueNutriologist" onClick={ $('#menu-toggle').click() }>Catalogo de Nutricionistas</Link>
        </li>
      )
    } else {
      Catalogue = ( 
        <li>
          <Link to={"/profile/"+Nutriologist} onClick={ $('#menu-toggle').click() }>Mi nutriologo</Link>
        </li>
      )
    }
        ...
        <header>
          <nav className="navbar navbar-expand navbar-dark bg-dark static-top">
            ...
            onClick={ function(e) {
              ...
              <ul className="navbar-nav ml-auto ml-md-0">
                ...
                <li className="nav-item dropdown no-arrow">
                  ...
                  <div className="dropdown-menu mydropdown" aria-labelledby="userDropdown">
                    ...
                    <a className="dropdown-item mydropdown-item" href="" data-toggle="modal" onClick={this.logout} >Cerrar sesion</a>      
                  </div>
                </li>
              </ul>
              </nav>
              ...
              <ModalBody>
                ...
                <div className="form-group">
                  ...
                  <div className="form-group">
                    ...
                    onChange={this.handleInputChange}/>
                    <small id="phoneHelp" className="form-text text-muted">Nunca compartiremos tu numero de telefono con alguien mas.</small>
                  </div>
                  <div className="form-group">
              ...
              <ModalFooter>
                <Button color="primary" onClick={this.handleClickSubmmit}>Aceptar</Button>{' '}
                <Button color="secondary" onClick={this.toggle}>Cancelar</Button>
              </ModalFooter>
                <Button color="btn btn-danger" onClick={this.confirmDelete}>Eliminar cuenta</Button>
              </Modal>
          ...
          <nav className="navbar navbar-expand navbar-dark bg-dark static-top">
            ...
            <div className="sidebar">
               ...
               <div id="sidebar-wrapper">
                 <ul className="sidebar-nav">
                   <li className="sidebar-brand">
                     <a href="/vistaprincipal">Perfil</a>
                   </li>
                   <ul style={{ listStyleType: "none", padding: 0 }}>
                     <li>
