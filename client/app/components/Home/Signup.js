...
class Signup extends Component {
  ...
  render() {
    ...
    if (!signUpError) {
      userMessage = (
        <span>
          <h2 className="text-center" style={{color: '#00c851'}}>¡Unete a nosotros!</h2>
        </span>
      )
    } else {
      userMessage = (
...
<div>
        <section className="login-block" style={{padding: '90px'}}>
          <div className="container container2">
                    ...
                    <img className="d-block img-fluid" width="1100px" height="500px" src="/assets/img/img8.jpg" alt="First slide"/>
                      <div className="carousel-caption d-none d-md-block">
                        <div className="banner-text" style={{top: '-600px', width: '90%'}}>
                            <h2>Bienvenido a tu nuexo estilo de vida</h2>
            ...
            <ModalHeader onRequestClose={this.toggleModal}>Forma para Nutricionista</ModalHeader>
            <ModalBody>
                ...
                <div className="form-group">
                  <label for="InputMotherLastName">Segundo Apellido</label>
                  <input type="text" className="form-control"  
                ...
                <div className="form-group">
                  ...
                  value={profPhone}
                  onChange={this.handleInputChange}/>
                  <small id="phoneHelp" className="form-text text-muted">Nunca compartiremos tu telefono con nadie mas.</small>
                </div>
                <div className="form-group">
            ...
            <ModalFooter>
              <Button className="btn btn-login float-left" onClick={this.onProfSignUp}>Crear cuenta como nutricionista</Button>{' '}
            ...
            <ModalHeader>Forma para cliente</ModalHeader>
            <ModalBody>
              <form>
                <div className="form-group">
                  <label for="InputFirstName2">Nombre</label>
                  <input type="text" className="form-control"  
                ...
                <div className="form-group">
                  <label for="InputLastName2">Apellido</label>
                  <input type="text" className="form-control"  
                ...
                <div className="form-group">
                  <label for="InputUserName2">Nombre de usuario</label>
                  <input type="text" className="form-control"  
                  placeholder="Enter username"
                  name="signUpUserName"
                ...
                <div className="form-group">
                  <label for="InputPhone2">Telefono</label>
                  <input type="number" className="form-control"  
                  placeholder="+1 (555)555-5555"
                  name="signUpPhone"
                  value={signUpPhone}
            ...
            <ModalFooter>
              <Button className="btn btn-login float-left" onClick={this.onSignUp}>Crear cuenta como cliente</Button>{' '}
              <Button color="secondary" onClick={this.toggleModal2}>Cancelar</Button>
            </ModalFooter>
            </Modal>
      </div>           
      );
